...
xcopy /s F:\Projects\我的项目\RemoteControl\RemoteControl.Server\bin\Debug %TestDir%\RemoteControl.Server

md %TestDir%\RemoteControl.Client
xcopy /s F:\Projects\我的项目\RemoteControl\RemoteControl.Client\bin\Debug %TestDir%\RemoteControl.Client
